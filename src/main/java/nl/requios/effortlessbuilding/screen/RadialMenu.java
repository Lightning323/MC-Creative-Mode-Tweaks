...
public class RadialMenu extends Screen {
   ...
   public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
      ...
      MenuButton serverConfigButton = new MenuButton(ModeOptions.ActionEnum.OPEN_SERVER_CONFIG, (double)-157.0F, (double)13.0F, Direction.DOWN);
      boolean isSingleplayer = this.minecraft.isSingleplayer();
      ...
      buttons.add(new MenuButton(ModeOptions.ActionEnum.OPEN_CLIENT_CONFIG, (double)-131.0F, (double)13.0F, Direction.DOWN));
      MenuButton replaceBtn = new MenuButton(ModeOptions.ActionEnum.CYCLE_REPLACE_MODE, (double)-105.0F, (double)13.0F, Direction.DOWN);
   ...
   private void performAction(boolean fromMouseClick) {
      ...
      if (action != null) {
         ...
         if (action == ModeOptions.ActionEnum.OPEN_SERVER_CONFIG) {
            if (!this.minecraft.isSingleplayer() && (this.minecraft.player == null || !this.minecraft.player.hasPermissions(2))) {
               if (this.minecraft.player != null) {
                  this.minecraft.player.displayClientMessage(Component.translatable("creative_mode_tweaks.message.not_operator"), true);
                  if (fromMouseClick) {
                     this.performedActionUsingMouse = true;
                  }
               }
               ...
               this.performedActionUsingMouse = true;
               this.minecraft.setScreen(new ServerConfigScreen());
            }

            return;
         }

         if (action == ModeOptions.ActionEnum.OPEN_CLIENT_CONFIG) {
            this.performedActionUsingMouse = true;
            this.minecraft.setScreen(new ClientConfigScreen());
            return;
         }
